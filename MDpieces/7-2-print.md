...
<table class = "LaserCardWrapper">
    <tr>
        <td class = "LaserCardNames col-sm-4" colspan = "2">
            <h1> {{site.data.7-2-playerBlob.GoldenPlayer.PlayerName}}, {{site.data.7-2-playerBlob.GoldenPlayer.SkillLevelName}} </h1>
        </td>
    </tr>
    <tr>
...
<table class = "LaserCardWrapper">
    <tr>
        <td class = "LaserCardNames col-sm-4" colspan = "2">
            <h1> {{site.data.7-2-playerBlob.SilverPlayer.PlayerName}}, {{site.data.7-2-playerBlob.SilverPlayer.SkillLevelName}} </h1>
        </td>
    </tr>
    <tr>
        <td class = "LaserCardBlock col-sm-4" style = "width:50%;" >
    ...
    <tr>
        <td class = "LaserCardBlock col-sm-4" style = "width:50%;" >
            Average Stars: {{site.data.7-2-playerBlob.SilverPlayer.StarQuality}} stars <br/>
            ...
            <br/><b>Claim to Fame:</b> Silver star! {{site.data.7-2-playerBlob.GoldenPlayer.PlayerName}} beat the second most other members this month.
            </p>
        </td>
        <td class = "LaserCardBlock col-sm-6" >
...
<table class = "LaserCardWrapper">
    <tr>
        <td class = "LaserCardNames col-sm-4" colspan = "2">
            <h1> {{site.data.7-2-playerBlob.BronzePlayer.PlayerName}}, {{site.data.7-2-playerBlob.BronzePlayer.SkillLevelName}} </h1>
        </td>
    </tr>
    <tr>
        <td class = "LaserCardBlock col-sm-4" style = "width:50%;" >
    ...
    <tr>
        <td class = "LaserCardBlock col-sm-4" style = "width:50%;" >
            ...
            <br/><b>Claim to Fame:</b> Bronze star! {{site.data.7-2-playerBlob.GoldenPlayer.PlayerName}} beat the third most other members this month.
            </p>
        </td>
        <td class = "LaserCardBlock col-sm-6" >
...
<table class = "LaserCardWrapper">
    <tr>
        <td class = "LaserCardNames col-sm-4" colspan = "2">
            <h1> {{site.data.7-2-playerBlob.OtherPlayer1.PlayerName}}, {{site.data.7-2-playerBlob.OtherPlayer1.SkillLevelName}} </h1>
        </td>
    </tr>
    <tr>
        <td class = "LaserCardBlock col-sm-4" style = "width:50%;" >
...
<table class = "LaserCardWrapper">
    <tr>
        <td class = "LaserCardNames col-sm-4" colspan = "2">
            <h1> {{site.data.7-2-playerBlob.OtherPlayer2.PlayerName}}, {{site.data.7-2-playerBlob.OtherPlayer2.SkillLevelName}} </h1>
        </td>
    </tr>
    <tr>
        <td class = "LaserCardBlock col-sm-4" style = "width:50%;" >
    ...
    <tr>
        <td class = "LaserCardBlock col-sm-4" style = "width:50%;" >
            ...
            <br/><b>Claim to Fame:</b> {{site.data.7-2-playerBlob.OtherPlayer2.PlayerName}} Has the best achievements of anyone here!
            </p>
        </td>
        <td class = "LaserCardBlock col-sm-6" >
