...
<table class = "LaserCardWrapper">
    ...
    <tr>
        <td class = "LaserCardBlock col-sm-4" style = "width:50%;" >
            Average Stars: {{site.data.7-9-playerBlob.SilverPlayer.StarQuality}} stars <br/>
            ...
            <br/><b>Claim to Fame:</b> Silver star! {{site.data.7-9-playerBlob.GoldenPlayer.PlayerName}} beat the second most other members this month.
            </p>
        </td>
        <td class = "LaserCardBlock col-sm-6" >
...
<table class = "LaserCardWrapper">
    ...
    <tr>
        <td class = "LaserCardBlock col-sm-4" style = "width:50%;" >
            ...
            <br/><b>Claim to Fame:</b> Bronze star! {{site.data.7-9-playerBlob.GoldenPlayer.PlayerName}} beat the third most other members this month.
            </p>
        </td>
        <td class = "LaserCardBlock col-sm-6" >
